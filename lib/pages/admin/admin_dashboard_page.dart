...
class _AdminDashboardPageState extends State<AdminDashboardPage> {
  ...
  // Fungsi untuk menampilkan About (Poin 3)
      ...
      builder: (context) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Icon(Icons.local_hospital, color: Color(0xFF3F6DF6), size: 50),
            const SizedBox(height: 16),
            const Text("Heal Sync v1.0.0", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
            const SizedBox(height: 10),
            const Text("Sistem Manajemen Rumah Sakit Digital.", textAlign: TextAlign.center, style: TextStyle(color: Colors.grey)),
            const SizedBox(height: 20),
          ],
        ),
      ),
...
Widget _header() {
  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: const [
      Text('ADMIN', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600)),
      SizedBox(height: 4),
        ...
        child: Row(
          children: [
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: const [
                Text('Kelola Dokter', style: TextStyle(fontWeight: FontWeight.w600, fontSize: 14)),
                SizedBox(height: 4),
                Text('CRUD & jadwal', style: TextStyle(color: Colors.grey, fontSize: 12)),
              ],
            ),
          ],
        ),
...
Widget _doctorList() {
  return StreamBuilder<QuerySnapshot>(
    ...
    builder: (context, snapshot) {
      ...
      if (!snapshot.hasData || snapshot.data!.docs.isEmpty) return const Center(child: Text("Belum ada data dokter"));
      ...
      return ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return Material(
            ...
            elevation: 1,
            child: ListTile(
              leading: const CircleAvatar(backgroundColor: Color(0xFFEAF1FF), child: Icon(Icons.person, color: Colors.blue)),
